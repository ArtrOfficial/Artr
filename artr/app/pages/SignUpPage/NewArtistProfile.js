    ...
    <div className="flex flex-col w-screen mb-24">
      <div className="flex flex-col mx-auto w-11/12">
        <div className="flex items-center">
          <div className="poppins-semibold text-2xl mb-2 mr-auto">Profile</div>
      ...
      <div className="flex mx-auto w-11/12 mt-8">
        <div className="poppins-med mr-52">Profile Picture</div>
        <div className="poppins-med">Profile Banner</div>
      </div>
      ...
      <div className="flex flex-col mx-auto w-11/12 mt-14">
        <div className="poppins-med">Description (Max 300 Characters)</div>
        <textarea
      ...
      <div className="flex flex-col mx-auto w-11/12 mt-11">
        <div className="poppins-med">Social Media Links</div>
        <div className="ml-5 mt-4">
          <div className="flex">
            <div className="montserrat-reg w-32">Instagram</div>
            <input type="text" className="border rounded-lg w-80 h-8" />
          </div>
          <div className="flex mt-4">
            <div className="montserrat-reg w-32">Kofi</div>
            <input type="text" className="border rounded-lg w-80 h-8" />
          </div>
          <div className="flex mt-4">
            <div className="montserrat-reg w-32">Patreon</div>
            <input type="text" className="border rounded-lg w-80 h-8" />
          </div>
          <div className="flex mt-4">
            <div className="montserrat-reg w-32">Personal Site</div>
            <input type="text" className="border rounded-lg w-80 h-8" />
          </div>
          <div className="flex mt-4">
            <div className="montserrat-reg w-32">TikTok</div>
            <input type="text" className="border rounded-lg w-80 h-8" />
          </div>
          <div className="flex mt-4">
            <div className="montserrat-reg w-32">Twitter</div>
            <input type="text" className="border rounded-lg w-80 h-8" />
          </div>
        </div>
      </div>
      <div className="flex flex-col mx-auto w-11/12 mt-11">
        <div className="poppins-semibold text-2xl mb-2">Commission Menu</div>
        <hr />
      ...
      <div className="flex flex-col mx-auto w-11/12 mt-16">
        <div className="poppins-semibold text-2xl mb-2">Commission Gallery</div>
        <hr />
        <div className="flex items-center justify-center w-72 h-52 mt-12 shadow-custom-lg">
          <button className="flex border-2 border-customPurple rounded-xl poppins-reg text-sm text-customPurple underline items-center justify-center px-2 w-28">
            Upload New
      ...
      <div className="flex flex-col mx-auto w-11/12 mt-16">
        <div className="poppins-semibold text-2xl mb-2">FAQs</div>
        <hr />
        <div className="flex items-center mt-4">
          ...
          <div className="flex flex-col w-full">
            <div className="montserrat-reg mb-1">Question</div>
            <input type="text" className="border w-full rounded-lg h-8" />
            <div className="montserrat-reg mt-2 mb-1">Answer</div>
            <input type="text" className="border w-full rounded-lg h-8" />
          </div>
        </div>
