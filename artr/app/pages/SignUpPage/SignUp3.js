...
function SignUp3() {
  return (
    <div className="flex flex-col inter-med text-sm md:mt-4">
      <div className="mb-2">Artr ID</div>
      <input
        type="text"
        className="mb-4 border border-customPurple md:rounded-2xl rounded-lg w-96 h-8 pl-2"
      />
