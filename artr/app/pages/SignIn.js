        ...
        <div className="flex flex-col items-center justify-center mx-20 my-14">
          ...
          <div className="flex flex-col mb-5">
            <div className="flex mb-2">
              <label className="mr-auto text-sm font-medium">Password</label>
          ...
          <div className="mb-4 text-sm font-medium">Or</div>
          <button className="flex justify-center border-2 border-customPurple rounded-3xl w-80 mb-14 text-sm font-medium py-2">
            Sign in with Google
          </button>
          <div className="text-xl font-medium mb-3">New to Artr?</div>
          <Link
            href="/pages/SignUpPage"
            className="bg-customPurple text-white rounded-2xl w-20 poppins-semibold text-sm py-1.5 px-2.5 shadow-lightPurple text-center"
          >
            Sign Up
          </Link>
        </div>
